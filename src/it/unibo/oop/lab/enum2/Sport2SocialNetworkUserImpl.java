...
public class Sport2SocialNetworkUserImpl<U extends User> extends SocialNetworkUserImpl<U> {
    ...
    public Set<Sport> getSport(){
    	Set<Sport> newSport = new HashSet<>();
    	for (Sport sports : this.sports) {
    		newSport.add(sports);
    	}
    	return newSport;
    }
    ...
    public Set<Sport> getIndividualSports() {
    	Set<Sport> newIndoorSport = new HashSet<>();
    	for (Sport sports : this.sports) {
    		if(sports.isIndividualSport()) {
    			newIndoorSport.add(sports);
    		}
    	}
    	return newIndoorSport;
    }
